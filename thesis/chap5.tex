...
For the seven students in Chile, I acquired the materials from the same vendor, and shipped them to my mother's home in Chile. She also sorted them into kits and then distributed them to the participants, via pickup or mail.
...
After the completion of the workshops, I sent the students a Google form to ask for anonymous feedback. The students gave very encouraging reviews that make me consider this workshop a success. I hope to teach it again, and to xpand it to a semester-long class for college education. 

...
In contrast to the current state of industrial \acrshort{ML} with its harmful algorithmic bias and oppressive facial recognition technologies, Tiny Trainable Instruments hopes to be a platform for critical, safe, and artistic creation.

This project is a hands-on invitation to ethical creative \acrshort{ML} and instrument making with microcontrollers. 
...
Up until starting this research, I thought \acrshort{ML} relied on expensive and restrictive hardware, and I feared for my privacy and agency, in the form of data leaks, and bias and lack of representation of bodies and voices like me on the existing databases and models.

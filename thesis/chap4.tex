...
Tiny Trainable Instruments is a wrapper of recent Arduino software libraries for \acrshort{ML}, repackaging them for artistic purposes. It follows the tradition of other toolkits for artists that foster accesibility to more complex and low-level software, such as p5.js and its wrapping of HTML5 techniques, and openFrameworks use of C++ and OpenGL for graphic-oriented applications, among others.

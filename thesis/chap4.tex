...
Their Kastle line of synthesizers is is also based on microcontrollers, and it features a patchbay for making connections with jumper wires, the same used for prototyping in electronic breadboards, which made me lose the imposter syndrome of thinking that if I release Tiny Trainable Instruments are also valid, despite living in breadboards instead of custom printed circuit boards. Also, these are forgiving instruments, their inputs and outputs are robust enough to allow for mistakes in connections, in an electrical and mechanical way.
...
\begin{table}[h!]
    ...
    \begin{tabular}{ | l | l | l | l | l | }
        ...
        \hline 
        BASTL & microGranny 2 & 2016 & microcontroller & Arduino \\
        BASTL & Kastle v1.5 & 2017 &microcontroller  & Arduino \\
        Critter \& Guitari & Organelle & 2016 & computer & Linux \\
        Critter \& Guitari & EYESY & 2020 & computer & Linux \\
        monome & aleph & 2013 & computer & Linux \\
        monome & norns & 2018 & computer & Linux \\
        Shbobo & Shnth & 2013 & microcontroller & ARM Cortex \\
        Shbobo & Shtar & 2017 & microcontroller & ARM Cortex 
    \end{tabular}

...
This chapter describes the process of conceptualizing and developing the Tiny Trainable Instruments project. It is an antidisciplinary thesis living at the interstitial spaces between the fields of \acrlong{AI}, electrical engineering, computer science, media arts, music, and education, among others.

This project is a hands-on invitation to ethical creative \acrshort{ML} and instrument making with microcontrollers. Also, a critical response to the current state of industrial \acrshort{ML} with its harmful algorithmic biases and oppressive facial recognition technologies.

Tiny Trainable Instruments is a wrapper of recent Arduino software libraries for \acrshort{ML}, repackaging them for artistic purposes. It follows the tradition of other toolkits for artists that foster accessibility to more complex and low-level software, such as p5.js and its wrapping of HTML5 techniques, and openFrameworks use of C++ and OpenGL for graphic-oriented applications, among others.

This project lays down the complete software and hardware infrastructure needed for people to learn how to use microcontrollers and sensors, in order to create their own databases, and then training and deploying \acrshort{ML} algorithms that control multimedia artistic actuators. With this, artists can create devices that are able to recognize colors, gestures, and speech, for artistic experimentation with sound, movement, light, and text, among others.

Industrial \acrshort{ML} has been a field with many barriers of entry for beginners, including its technical complexity, and need of specialized expensive hardware. This project is a step towards reverting this trend, by its open source nature and use of cheaper materials. It also is a political manifesto, by promoting \acrshort{ML} that is respectful of privacy, and deployed on microcontrollers to circumvent the restrictions and surveillance enacted by corporations and governments. 
...
This library is a repository hosted on GitHub, to foster collaboration via \glspl{issue} and \glspl{pull-request}. Each \gls{commit} is annotated and commented, in order to show people the whole process and effort involved in writing this thesis project.
...
I want to build a wider community of artists working with ethical \acrshort{ML}, and building software tools and hardware instruments. The modularity and open source nature of this project is so that this project outlives itself, and that its different sections can be incorporated into further projects by myself and anyone interested in doing so.

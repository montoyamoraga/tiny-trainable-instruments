...
This project's main contribution is the TinyTrainable Arduino software library, which allows you to create flexible multimedia instruments, where you can combine any input with any output, and it runs on the microntroller Arduino Nano 33 BLE Sense.
...
The library is flexible, and it allows any of the 3 available inputs, with any of the 7 possible outputs, summarized on this table.
...
For the sensors of the inputs I used the embedded sensors of the microcontroller with their corresponding open source libraries, and processed the input data with 2 recently released open source \acrshort{ML} libraries, summarized on this table.

...
\subsection{Code to build databases and train ML models}

\subsection{Workshop and educational material}

\section{Design principles}

In this section I explain the design principles that I followed.
...
The software library is inexpensive, it can be downloaded from the internet, and it's free.

The materials picked were the most cheap ones I could think of, and they are often used in similar educational contexts, because they can be reusable, and are resistant.

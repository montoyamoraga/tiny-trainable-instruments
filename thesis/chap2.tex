...
This project's main contribution is the TinyTrainable Arduino software library. This library allows you to create flexible instruments, where you can combine any input with any output, which are summarized on this table.

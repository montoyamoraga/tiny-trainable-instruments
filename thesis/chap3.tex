...
\section{Other Opera of the Future research projects}
...
Fluid Music is Charles Holbrow's PhD thesis. It is a library for library design, documentation for contributors. The design of the interface, documentation, and scope of the thesis were a direct influence on the documentation and API coding style of this project. During the academic year 2020-2021 I participated in Charles' workshop, which also pushed me to include a workshop as part of my user feedback and release of this project. 
